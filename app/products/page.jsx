...
export const metadata = {
  title: "Our Products — CAXiE Technologies Ltd",
  description:
    "CAXiE Technologies Ltd is building its own software products alongside client work — security monitoring, data integration, and web security tools purpose-built for Nigerian businesses.",
  openGraph: {
    title: "CAXiE Technologies Ltd Products",
    description:
      "Software and tools built by CAXiE — for Nigerian businesses, from Kano to the world.",
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-gray-400 text-lg max-w-2xl leading-relaxed">
            Alongside client engagements, CAXiE is developing its own software
            products — tools that address gaps we encounter repeatedly in the
            Nigerian business environment. These are not side projects; they are
            direct extensions of our core service lines.
          </p>
          <div className="mt-8 p-4 bg-brand-600/10 border border-brand-600/20 rounded-xl inline-block">
            <p className="text-brand-300 text-sm">
              💡 <strong>Early access:</strong> Interested in beta testing any
              of these products?{" "}
              <a
                href="mailto:contact@caxietechnologies.com?subject=Product Beta Interest"
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-4 mb-4">
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center border ${product.bg}`}
                  >
                  ...
                  <span
                    className={`text-xs font-medium px-2.5 py-1 rounded-full border ${statusColors[product.status] || "bg-gray-700 text-gray-400 border-gray-600"}`}
                  >
                    {product.status}
                  </span>
                </div>
                ...
                <p className={`text-sm font-medium mb-3 ${product.color}`}>
                  {product.tagline}
                </p>
                <span className="text-xs text-gray-500 bg-white/5 rounded-full px-2.5 py-1 w-fit mb-4">
                  {product.category}
                </span>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-500 text-sm">
              ...
              if you have a product idea you&apos;d like CAXiE to build or
              co-develop.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="card border border-brand-600/20 bg-brand-600/5 text-center">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-lg mx-auto">
                CAXiE takes on co-development partnerships for software products
                with proven market demand. If you have a validated idea and need
                a technical co-founder or development partner, let&apos;s talk.
              </p>
