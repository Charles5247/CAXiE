...
export const metadata = {
  title: "Web Development Classes & Tech Mentorship — CAXiE Technologies Ltd",
  description:
    "CAXiE Technologies Ltd runs beginner web development classes and mentorship programs in Kano, Nigeria — building the next generation of Nigerian tech talent.",
  openGraph: {
    title: "CAXiE Tech Classes — Beginner Web Development in Kano, Nigeria",
    description:
      "Learn web development from a working practitioner. CAXiE Technologies Ltd runs structured beginner classes and 1-on-1 mentorship in Kano, Nigeria (and remotely).",
...
export default function TeachingPage() {
  return (
    <div className="bg-[#0f0a1a]">
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-display font-bold text-4xl sm:text-5xl text-white max-w-3xl leading-tight">
            ...
            <span className="gradient-text">
              Taught by someone who does it professionally.
            </span>
          </h1>
          <p className="mt-6 text-gray-400 text-lg max-w-2xl leading-relaxed">
            CAXiE Technologies Ltd runs beginner web development classes
            designed for people with zero technical background — in Kano,
            Nigeria, and remotely. This is how we invest in the next generation
            of Nigerian tech talent.
          </p>
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 id="why-heading" className="section-title">
              Not a bootcamp. Not a YouTube playlist.
            </h2>
            <p className="section-subtitle mx-auto text-center">
              You learn from someone who builds production systems for real
              clients — including the very website you&apos;re reading now.
            </p>
          </div>
      ...
      <section
        id="curriculum"
        className="section bg-[#1a0f2e] scroll-mt-20"
      ...
      >
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle mx-auto text-center">
              From zero to your first deployed website — with security awareness
              throughout.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {curriculum.map((mod, idx) => (
              <div
                key={mod.module}
                className="card border border-white/10 hover:border-brand-600/30"
              >
                  ...
                  <div className="flex-1">
                    <ul className="flex flex-wrap gap-2">
                      {mod.topics.map((t) => (
                        <li
                          key={t}
                          className="badge bg-white/5 border border-white/10 text-gray-300 text-xs"
                        >
                          {t}
                        </li>
                      ))}
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div
                key={f.name}
                className="card border border-brand-600/20 bg-brand-600/5"
              >
                <span className="badge-brand text-xs mb-4 inline-block">
                  {f.badge}
                </span>
      ...
      <section className="section bg-gradient-to-br from-brand-900 to-[#0f0a1a]">
        <div className="container-max px-4 sm:px-6 lg:px-8 text-center max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-gray-400">
            Send us a WhatsApp message with your name and which format interests
            you. Xavier personally responds to class enquiries.
          </p>
          ...
          <p className="text-gray-500 text-sm">
            Classes run in Kano, Nigeria. Remote slots available. Enquire for
            next cohort dates.
          </p>
        </div>
      </section>
