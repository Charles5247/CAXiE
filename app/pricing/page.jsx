...
export const metadata = {
  title: "Pricing — CAXiE Technologies Ltd",
  description:
    "Transparent pricing for CAXiE Technologies Ltd services — cybersecurity, ICT infrastructure, web development, data analytics, and fractional CTO engagements. Based in Kano, Nigeria.",
  openGraph: {
    title: "CAXiE Technologies Ltd Pricing",
    description:
      "Tiered pricing for IT consultancy, cybersecurity, web development, and fractional CTO services.",
...
const pricingTiers = [
  {
    ...
    cta: "Get a quote",
    ctaHref:
      "https://wa.me/2348165443398?text=Hi%20CAXiE%2C%20I%27m%20interested%20in%20the%20Starter%20tier.",
    highlighted: false,
  },
  {
    name: "Growth",
    ...
    ctaHref:
      "https://wa.me/2348165443398?text=Hi%20CAXiE%2C%20I%27m%20interested%20in%20the%20Growth%20tier.",
    highlighted: true,
  },
  {
    name: "Enterprise",
    ...
    ctaHref:
      "https://wa.me/2348165443398?text=Hi%20CAXiE%2C%20I%27d%20like%20to%20discuss%20an%20Enterprise%20engagement.",
    highlighted: false,
  },
];
...
const addons = [
  {
    name: "Security awareness training (per session)",
    price: "₦80,000 – ₦200,000",
    placeholder: true,
  },
  {
    name: "Additional post-launch support months",
    price: "₦50,000/month",
    placeholder: true,
  },
  {
    name: "SEO content production (per article)",
    price: "₦25,000 – ₦60,000",
    placeholder: true,
  },
  {
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-gray-400 text-lg max-w-2xl leading-relaxed">
            The prices below are indicative ranges based on typical project
            scope.{" "}
            <strong className="text-white">
              [PLACEHOLDER: Xavier to confirm final tier names, price points,
              and inclusions before launch.]
            </strong>{" "}
            Every engagement gets a written proposal before we start — so you
            know exactly what you&apos;re paying for.
          </p>
          <div className="mt-6 bg-brand-600/10 border border-brand-600/20 rounded-xl p-4 inline-block">
            <p className="text-brand-300 text-sm">
              💡 <strong className="text-white">Pricing philosophy:</strong> We
              scope around outcomes, not hours. You pay for results — not
              time-tracked reports.
            </p>
          </div>
        </div>
      </section>
            ...
            {pricingTiers.map((tier) => (
              <div
                ...
                className={`relative rounded-3xl border-2 p-8 flex flex-col ${tier.color} ${
                  tier.highlighted
                    ? "bg-brand-600/10 shadow-brand-lg"
                    : "bg-white/3"
                }`}
              >
                {tier.highlighted && (
                ...
                <div className="mb-6">
                  ...
                  <h3
                    className={`font-display font-bold text-2xl mb-1 ${tier.headingColor}`}
                  >
                    {tier.name}
                  </h3>
                  ...
                  {tier.placeholder && (
                    <p className="text-yellow-500/70 text-xs mt-1">
                      * Indicative — final prices to be confirmed
                    </p>
                  )}
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {addons.map((a) => (
              ...
              >
                ...
                <span
                  className={`font-semibold text-sm flex-shrink-0 ${a.placeholder ? "text-yellow-400" : "text-brand-400"}`}
                >
                  {a.price}
                </span>
              </div>
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle mx-auto text-center">
              We believe buying friction is a hidden cost. Here&apos;s exactly
              what happens from first contact to project kickoff.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "WhatsApp or contact form — whichever is easier. Tell us what you need.",
              },
              {
                step: "2",
                label: "Discovery call",
                desc: "Within 24 hours, we schedule a 30-minute call to understand your project and environment.",
              },
              {
                step: "3",
                label: "Written proposal",
                desc: "Within 48–72 hours of the call: scope, deliverables, timeline, and fixed price in writing.",
              },
              {
                step: "4",
                label: "Project kickoff",
                desc: "Once the proposal is accepted and first payment confirmed, we start within agreed SLA.",
              },
            ].map((item) => (
      ...
      <section className="section bg-gradient-to-br from-brand-900 to-[#0f0a1a]">
        <div className="container-max px-4 sm:px-6 lg:px-8 text-center max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-gray-400">
            It starts with a conversation. Tell us what you need — we&apos;ll
