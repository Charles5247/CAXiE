...
const services = [
  {
    ...
    whoFor:
      "Healthcare, finance, government, any organisation handling sensitive data or operating critical infrastructure.",
    process: [
      {
        step: "01",
        label: "Discovery",
        desc: "We map your current environment, identify assets, and document your current threat exposure.",
      },
      {
        step: "02",
        label: "Assessment",
        desc: "Formal vulnerability scan and security audit against industry baselines (NIST, ISO 27001 principles).",
      },
      {
        step: "03",
        label: "Remediation plan",
        desc: "Prioritised action plan with timelines and resource requirements — not a report that sits in a drawer.",
      },
      {
        step: "04",
        label: "Implementation",
        desc: "We execute the hardening plan alongside your team or independently, with full documentation.",
      },
      {
        step: "05",
        label: "Ongoing monitoring",
        desc: "Optional retainer for continuous monitoring, quarterly reviews, and incident response.",
      },
    ],
  ...
  },
  {
    ...
    whoFor:
      "Businesses establishing a new facility, scaling to new locations, or inheriting legacy infrastructure that needs a systematic overhaul.",
    process: [
      {
        step: "01",
        label: "Site survey",
        desc: "Physical and logical assessment of your current environment, including existing equipment, cabling, and bandwidth.",
      },
      {
        step: "02",
        label: "Architecture design",
        desc: "A network and systems architecture designed around your workload, not a standard template.",
      },
      {
        step: "03",
        label: "Deployment",
        desc: "Installation, configuration, and testing — with security hardened from day one.",
      },
      {
        step: "04",
        label: "Handover & documentation",
        desc: "Full network documentation and staff handover training so your team can manage what we build.",
      },
      {
        step: "05",
        label: "Support retainer",
        desc: "Optional ongoing support, monitoring, and maintenance — with defined SLAs.",
      },
    ],
    caseStudyLink: null,
    caseStudyLabel: null,
  },
  {
    ...
    tagline:
      "Your operational data is already worth something. Let's surface it.",
    ...
    whoFor:
      "Operations-heavy businesses, healthcare providers, financial services, and any organisation where decisions are being made on gut feel rather than data.",
    process: [
      {
        step: "01",
        label: "Data audit",
        desc: "We inventory your existing data sources — databases, spreadsheets, third-party systems — and assess data quality.",
      },
      {
        step: "02",
        label: "Question mapping",
        desc: "We document the 5-10 core business questions your leadership actually needs answered.",
      },
      {
        step: "03",
        label: "Pipeline & dashboard build",
        desc: "We build the data pipeline and dashboards to answer those questions — in your existing tools where possible.",
      },
      {
        step: "04",
        label: "Training & handover",
        desc: "Your team learns to read and interpret the dashboards, and we document the pipeline for your internal records.",
      },
      {
        step: "05",
        label: "Iteration",
        desc: "Quarterly reviews to update metrics as your business priorities evolve.",
      },
    ],
    caseStudyLink: null,
    caseStudyLabel: null,
  },
  {
    ...
    tagline:
      "A website that is invisible to search engines is not a website. It's a liability.",
    color: "text-pink-400",
    ...
    whoFor:
      "Businesses with existing sites that are invisible to search engines, startups establishing their first credible digital presence, and enterprises migrating from legacy platforms.",
    process: [
      {
        step: "01",
        label: "Discovery brief",
        desc: "We document your audience, competitive positioning, current visibility issues, and conversion goals.",
      },
      {
        step: "02",
        label: "Architecture & design",
        desc: "Sitemap, wireframes, design system — designed for conversion and technical SEO before a line of code is written.",
      },
      {
        step: "03",
        label: "Development",
        desc: "Server-rendered, accessible, performant build — with structured data, sitemap, and Open Graph metadata built in.",
      },
      {
        step: "04",
        label: "Audit & hardening",
        desc: "Dependency audit, WCAG 2.1 AA accessibility review, and Core Web Vitals verification before launch.",
      },
      {
        step: "05",
        label: "Launch & handover",
        desc: "DNS migration, CMS training, and 30-day post-launch support included.",
      },
    ],
    caseStudyLink: "/case-studies/dala-orthopedic",
  ...
  },
  {
    ...
    tagline:
      "Enterprise-level technical leadership. Retainer model. No full-time overhead.",
    ...
    whoFor:
      "Series A/B startups, growth-stage SMEs, and established businesses undertaking digital transformation who need a named senior technical leader without a full-time commitment.",
    process: [
      {
        step: "01",
        label: "Technical audit",
        desc: "We assess your current technology stack, team structure, vendor relationships, and outstanding technical debt.",
      },
      {
        step: "02",
        label: "Roadmap development",
        desc: "A 12-month technology roadmap aligned to your business objectives, with quarterly milestones.",
      },
      {
        step: "03",
        label: "Engagement model",
        desc: "Defined scope: weekly advisory calls, async access, vendor negotiation, board/investor attendance as needed.",
      },
      {
        step: "04",
        label: "Active engagement",
        desc: "Ongoing advisory, technical reviews, hiring input, and escalation path for technical decisions.",
      },
      {
        step: "05",
        label: "Transition planning",
        desc: "If/when the business is ready for a full-time CTO, we support the transition — including in-house candidate evaluation.",
      },
    ],
  ...
  },
  {
    ...
    tagline:
      "Custom software, mobile apps, and desktop applications — built to spec, not off a shelf.",
    ...
    whoFor:
      "Businesses with workflows that existing SaaS tools can't handle; organisations needing a mobile app to serve customers or staff; companies wanting to own their technology stack rather than rent it indefinitely.",
    process: [
      {
        step: "01",
        label: "Requirements scoping",
        desc: "We map your workflow, user journeys, and data requirements before writing a line of code. Skipping this is how projects fail.",
      },
      {
        step: "02",
        label: "Architecture design",
        desc: "We propose a technical architecture — stack, data model, integrations, security model — and walk you through it before we begin.",
      },
      {
        step: "03",
        label: "Iterative development",
        desc: "Development in two-week sprints with working software delivered at each sprint. You see real progress, not status updates.",
      },
      {
        step: "04",
        label: "Testing & hardening",
        desc: "QA, security review, and performance testing before any handover. We don't ship software we haven't tested under realistic conditions.",
      },
      {
        step: "05",
        label: "Deployment & handover",
        desc: "We deploy to your environment, document the system, and train your team. Ongoing support available under retainer.",
      },
    ],
    caseStudyLink: null,
    caseStudyLabel: null,
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-display font-bold text-4xl sm:text-5xl text-white max-w-3xl leading-tight">
            ...
            <span className="gradient-text">practical, resilient</span>{" "}
            foundation.
          </h1>
          <p className="mt-6 text-gray-400 text-lg max-w-2xl leading-relaxed">
            Whether you need to strengthen your systems, modernise your
            software, unlock your data, or bring senior technology leadership
            into your business, each service below is delivered with the same
        ...
        >
          <div className="container-max px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-start gap-5 mb-10">
              <div
                className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 border ${svc.bg} ${svc.color}`}
              >
                {svc.icon}
              </div>
              <div>
                <span
                  className={`text-xs font-semibold uppercase tracking-widest ${svc.color} mb-1 block`}
                >
                ...
                <div>
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {svc.offerings.map((o) => (
                      ...
                      >
                        <svg
                          className={`w-4 h-4 mt-0.5 flex-shrink-0 ${svc.color}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {svc.process.map((p) => (
                      <div
                        key={p.step}
                        className={`border-l-4 ${svc.accentBorder} pl-4 py-1`}
                      >
                        <div className="flex items-center gap-2 mb-1">
                          <span className={`text-xs font-bold ${svc.color}`}>
                            {p.step}
                          </span>
              ...
              <div className="space-y-6">
                ...
                {svc.caseStudyLink && (
                  <div className={`card border ${svc.bg}`}>
                    <h3
                      className={`font-display font-semibold mb-2 text-sm uppercase tracking-wider ${svc.color}`}
                    >
                      Live case study
                    </h3>
                    ...
                    <Link
                      ...
                      className={`text-sm font-medium ${svc.color} hover:underline`}
                    >
      ...
      <section className="section bg-gradient-to-br from-brand-900 to-[#0f0a1a]">
        <div className="container-max px-4 sm:px-6 lg:px-8 text-center max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-gray-400">
            Describe your business challenge — we&apos;ll recommend the right
            engagement model and give you a straight answer about whether CAXiE
            is the right fit.
          </p>
