...
const services = [
  {
    ...
    description: 'Threat assessments, security audits, identity management, and hardening — for organisations that cannot afford a breach.',
    icon: (
  ...
  },
  {
    ...
    description: 'Network design, deployment, cloud integration, and enterprise systems — built to scale with your organisation.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Analytics dashboards, business intelligence, and decision-support tools that convert your data into competitive advantage.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Full-stack web development, SEO, branding, and digital marketing — systems that are visible to search engines and convert visitors.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Enterprise-level technical leadership on retainer — strategy, vendor management, team oversight, and architecture guidance without a full-time hire.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const caseStudyPreview = {
  ...
  metrics: [
    { label: 'Patient digital touchpoints', value: '↑ Significantly', placeholder: true },
...
export default function HomePage() {
  return (
    <div className="bg-[#0f0a1a]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="inline-flex items-center gap-2 bg-brand-600/15 border border-brand-600/30 rounded-full px-4 py-1.5">
                ...
                <span className="text-brand-300 text-sm font-medium">IT Consultancy · Kano, Nigeria</span>
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                {trustBadges.map((badge) => (
                  <div key={badge.label} className="flex items-center gap-1.5 text-sm text-gray-400">
      ...
      {/* ═══════════════════════════════════════════ SERVICES PREVIEW */}
      <section className="section bg-[#0f0a1a]" aria-labelledby="services-heading">
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((svc, idx) => (
              ...
              >
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${svc.bg} border ${svc.color}`}>
                ...
                <div className={`mt-4 flex items-center gap-1 text-sm font-medium ${svc.color}`}>
                  Learn more
            ...
            <div className="card border border-brand-600/20 bg-brand-600/5 flex flex-col items-center justify-center text-center gap-4 p-8">
              ...
              <div>
                <p className="font-display font-semibold text-white mb-1">Not sure what you need?</p>
                <p className="text-gray-400 text-sm">Tell us about your business challenge — we&apos;ll recommend the right solution.</p>
              </div>
              <a
      ...
      <section className="section bg-gradient-to-b from-[#0f0a1a] to-[#1a0f2e]" aria-labelledby="cases-heading">
        <div className="container-max">
          <div className="text-center mb-16">
            <span className="badge-brand mb-4 inline-block">Proof of Work</span>
            <h2 id="cases-heading" className="section-title">Not claims — evidence.</h2>
            <p className="section-subtitle mx-auto text-center">
              Real engagements. Real outcomes. Every case study below reflects an active or completed project, not a demo.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="card border border-white/10 hover:border-brand-600/30 group">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <span className="badge-blue text-xs mb-2 inline-block">Healthcare · Digital Transformation</span>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                {caseStudyPreview.metrics.map((m) => (
                  <div key={m.label} className="text-center">
                    <div className="text-brand-400 font-bold text-lg">{m.value}</div>
                    <div className="text-gray-500 text-xs mt-1">{m.label}</div>
                  </div>
                ))}
              </div>
              <Link href={caseStudyPreview.href} className="btn-secondary text-sm">
                Read Case Study
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
            ...
            <div className="card border border-white/10 hover:border-brand-600/30 group">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <span className="badge-brand text-xs mb-2 inline-block">VTU / Digital Services · Fractional CTO</span>
                  <h3 className="font-display font-bold text-white text-xl group-hover:text-brand-400 transition-colors">
                    3StarData
                  </h3>
                </div>
              ...
              <div className="bg-brand-600/10 border border-brand-600/20 rounded-xl p-4 mb-6">
                <p className="text-brand-300 text-sm">
                  <strong className="text-white">Engagement model:</strong> {ctoPreview.engagement}
                </p>
              </div>
      ...
      {/* ═══════════════════════════════════════════ TEACHING SECTION */}
      <section className="section bg-gradient-to-b from-[#1a0f2e] to-[#0f0a1a]" aria-labelledby="teaching-heading">
        <div className="container-max">
              ...
              <div className="card border border-brand-600/20 bg-brand-600/5 p-8">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/5 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-brand-400">Beginner</div>
                    <div className="text-gray-400 text-xs mt-1">friendly entry point</div>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-brand-400">Web Dev</div>
                    <div className="text-gray-400 text-xs mt-1">core curriculum</div>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-brand-400">1-on-1</div>
                    <div className="text-gray-400 text-xs mt-1">mentorship available</div>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-brand-400">Kano</div>
                    <div className="text-gray-400 text-xs mt-1">+ remote options</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="space-y-6 order-1 lg:order-2">
              <span className="badge-brand inline-block">Community Investment</span>
              <h2 id="teaching-heading" className="font-display font-bold text-3xl sm:text-4xl text-white">
                We&apos;re also building the next generation of Nigerian tech talent.
              </h2>
              <p className="text-gray-400 leading-relaxed">
                CAXiE runs beginner web development classes and mentorship programs — not as a side project, but as a core part of how we invest in the Nigerian tech ecosystem. Teaching is how we build trust, reputation, and community.
              </p>
      ...
      <section className="section bg-[#0f0a1a]" aria-labelledby="trust-heading">
        <div className="container-max">
          <div className="text-center mb-12">
            <h2 id="trust-heading" className="section-title">Why work with CAXiE?</h2>
          </div>
      ...
      {/* ═══════════════════════════════════════════ FINAL CTA */}
      <section className="section bg-gradient-to-br from-brand-900 via-brand-800 to-[#1a0f2e]" aria-labelledby="cta-heading">
        <div className="container-max">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            <h2 id="cta-heading" className="font-display font-bold text-4xl sm:text-5xl text-white leading-tight">
              Ready to work with a technology partner who takes your systems as seriously as you do?
            </h2>
            <p className="text-gray-300 text-lg">
              Tell us about your project. Response within 24 hours. No hard sell — just a straight conversation about what you need and whether CAXiE is the right fit.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/contact" className="btn-secondary text-base w-full sm:w-auto justify-center">
...
function MetricRow({ label, value, positive }) {
  return (
    <div className="flex items-center justify-between py-2 border-b border-white/5 last:border-0">
      ...
      <span className={`font-semibold text-sm ${positive ? 'text-green-400' : 'text-gray-300'}`}>{value}</span>
    </div>
  );
}
