...
const caseStudySchema = {
  ...
  "@type": "Article",
  headline:
    "Dala Orthopedic Hospital — Digital Transformation by CAXiE Technologies Ltd",
  description:
    "How CAXiE Technologies Ltd led the digital transformation of Dala Orthopedic Hospital, delivering secure systems, web presence, and operational improvements.",
  author: {
    "@type": "Person",
    ...
    <div className="bg-[#0f0a1a]">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          <span className="badge-blue inline-block mb-4">
          ...
          <h1 className="font-display font-bold text-4xl sm:text-5xl text-white max-w-3xl leading-tight">
            ...
            <span className="text-blue-400">
              From manual workflows to a secure digital infrastructure
            </span>
          </h1>
          <p className="mt-6 text-gray-400 text-lg max-w-2xl leading-relaxed">
            <strong className="text-yellow-400">
              [PLACEHOLDER: Xavier to supply final project scope, specific
              timeline, and measurable outcome metrics before launch.]
            </strong>{" "}
            The following represents the documented engagement structure.
            Numbers and specific metrics will be confirmed by the client before
            publication.
          </p>
        </div>
      </section>
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                label: "Client",
                value: "Dala Orthopedic",
                sub: "Kano, Nigeria",
              },
              {
                label: "Sector",
                value: "Healthcare",
                sub: "Orthopedic Hospital",
              },
              {
                label: "Services delivered",
                value: "Web + Security",
                sub: "Infrastructure + BI",
              },
          ...
          <div className="mb-16">
            ...
            <div className="prose-brand space-y-4">
              <p className="text-gray-300 leading-relaxed text-lg">
                Dala Orthopedic Hospital was operating with entirely manual
                patient management and administrative workflows — paper records,
                no digital appointment system, and no web presence. The result:
                staff time was consumed by administrative overhead that
                technology could eliminate, and the hospital was effectively
                invisible to patients searching for orthopedic care online.
              </p>
              <p className="text-gray-400 leading-relaxed">
                The secondary challenge was data security. Healthcare records
                are among the most sensitive data an organisation handles, and
                transitioning from paper to digital without a robust security
                model would have created more risk than it eliminated.
              </p>
              <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6">
                <h3 className="font-semibold text-white mb-3">
                  Key problems at engagement start:
                </h3>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-6">
              {[
                ...
                <div
                  key={ph.phase}
                  className="border-l-4 border-brand-600 pl-6 py-1"
                >
          ...
          <div className="mb-16">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-6 mb-8">
              <p className="text-yellow-300 text-sm">
                <strong>Placeholder note:</strong> The metrics below are
                structural placeholders. Final numbers (patient digital
                touchpoints, admin time saved, web traffic increase, security
                incidents prevented, etc.) to be confirmed by Xavier/Dala team
                before publication.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
              {[
                ...
                {
                  metric: "[X+]",
                  label: "Monthly organic web visitors",
                  note: "PLACEHOLDER",
                },
                {
                  metric: "0",
                  label: "Security incidents post-deployment",
                  note: "Confirmed",
                },
              ].map((m) => (
                <div key={m.label} className="card text-center">
                  <div className="font-display font-bold text-4xl text-brand-400 mb-2">
                    {m.metric}
                  </div>
                  <div className="text-gray-300 text-sm mb-2">{m.label}</div>
                  <span
                    className={`badge text-xs ${m.note === "Confirmed" ? "badge-green" : "badge-brand"}`}
                  >
                    {m.note}
                  </span>
                </div>
          ...
          <div className="card border border-white/10 mb-16">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                "Security hardening",
                "Technical SEO",
                "[PLACEHOLDER: additional stack items]",
              ].map((tag) => (
                <span key={tag} className="badge-brand text-xs">
                  {tag}
                </span>
              ))}
            </div>
      ...
      <section className="section bg-gradient-to-br from-brand-900 to-[#0f0a1a]">
        <div className="container-max px-4 sm:px-6 lg:px-8 text-center max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-gray-400">
            Whether you&apos;re a healthcare provider, a growing SME, or an
            enterprise — the CAXiE approach is the same: security-first,
            outcomes-focused, no boilerplate.
          </p>
