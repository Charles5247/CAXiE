...
export const metadata = {
  title: '3StarData — Fractional CTO Engagement | CAXiE Technologies',
  description:
    'How CAXiE Technologies founder Xavier serves as incoming fractional CTO for 3StarData — a Nigerian VTU/digital services platform — under a retainer + equity model.',
  openGraph: {
    title: 'Case Study: 3StarData — Fractional CTO Engagement',
    description: 'An active fractional CTO engagement: Xavier at 3StarData — retainer + equity model, technology roadmap, and strategic leadership.',
    ...
    <div className="bg-[#0f0a1a]">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          <span className="badge-brand inline-block mb-4">VTU / Digital Services · Fractional CTO</span>
          <h1 className="font-display font-bold text-4xl sm:text-5xl text-white max-w-3xl leading-tight">
            3StarData:<br />
            <span className="gradient-text">Fractional CTO — active engagement</span>
          </h1>
          <p className="mt-6 text-gray-400 text-lg max-w-2xl leading-relaxed">
            This is an ongoing engagement. Details disclosed here are public — what we can share about the structure and scope without breaching the active COA.{' '}
            <strong className="text-yellow-400">[PLACEHOLDER: Xavier to confirm what content is cleared for public disclosure.]</strong>
          </p>
          <div className="mt-4 inline-flex items-center gap-2 bg-green-500/15 border border-green-500/30 rounded-full px-4 py-2">
            ...
            <span className="text-green-300 text-sm font-medium">Active engagement</span>
          </div>
        </div>
      </section>
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { label: 'Sector', value: 'VTU / Digital', sub: 'Services reseller' },
              { label: 'Engagement type', value: 'Fractional CTO', sub: 'Retainer + equity' },
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto space-y-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="font-display font-bold text-2xl text-white">Context</h2>
            </div>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <p className="text-gray-400">
                Rather than making a premature full-time CTO hire, 3StarData engaged Xavier through CAXiE Technologies as incoming fractional CTO — a retainer + equity model with a defined clause for transitioning to full-time CTO as the company reaches target scale.
              </p>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="font-display font-bold text-2xl text-white">Engagement structure</h2>
            </div>
            <div className="bg-brand-600/10 border border-brand-600/20 rounded-2xl p-8 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  ...
                  { label: 'Transition clause', value: 'Full-time CTO at defined milestone' },
                  { label: 'Scope', value: 'Technology strategy, vendor mgmt, roadmap' },
                ].map((item) => (
                  <div key={item.label}>
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="font-display font-bold text-2xl text-white">What the engagement covers</h2>
            </div>
          ...
          <div className="card border border-brand-600/20 bg-brand-600/5 p-8">
            ...
            <div className="space-y-3 text-gray-400 text-sm leading-relaxed">
              ...
              <p>
                <Link href="/services#cto" className="text-brand-400 hover:underline">Learn more about CAXiE&apos;s Fractional CTO service →</Link>
              </p>
            </div>
          </div>
        </div>
