...
export const metadata = {
  ...
  description:
    "CAXiE Technologies Ltd blog: practical insights on cybersecurity, digital transformation, ICT infrastructure, and building technology businesses in Nigeria.",
  openGraph: {
    title: "CAXiE Technologies Ltd Blog & Insights",
    description:
      "Cybersecurity, data intelligence, web strategy, and tech leadership insights from the CAXiE Technologies Ltd team.",
...
const fallbackPosts = [
  {
    id: 1,
    title:
      "Why your Nigerian business website is invisible to Google — and how to fix it",
    excerpt:
      "Most Nigerian SME websites are built with client-side-only JavaScript frameworks. The result: Google's crawler visits your site and finds an empty shell. Here's what's happening and what a properly server-rendered site looks like.",
  ...
  },
  {
    id: 2,
    title:
      "The fractional CTO model: why it works for growth-stage Nigerian companies",
    excerpt:
      "Full-time CTOs are expensive. Junior developers making architectural decisions are more expensive. There's a third option — and it's gaining traction with the companies that grow fastest.",
  ...
  },
  {
    id: 3,
    title:
      "Five cybersecurity mistakes Nigerian SMEs make (and what they cost)",
    excerpt:
      "From weak password policies to unencrypted records, the same five mistakes appear in almost every security audit we run. This is what they look like, and the actual risk they carry.",
  ...
  },
  {
    ...
    excerpt:
      "You don't need a data warehouse to start making data-driven decisions. Here's a practical framework for organisations that are operationally data-rich but analytically data-dark.",
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-gray-400 text-lg max-w-2xl leading-relaxed">
            Cybersecurity, digital transformation, data intelligence, and
            building technology businesses in Nigeria. Written by the same team
            that delivers these services — not a content agency.
          </p>
        </div>
      </section>
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          ...
          {posts.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-gray-400 text-lg mb-6">
                Articles coming soon. Follow Xavier on X for previews.
              </p>
              <a
          ...
          <div className="mt-20 card border border-brand-600/20 bg-brand-600/5 p-8 text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Follow Xavier on X or connect on LinkedIn — content drops there
              first.
            </p>
    ...
    <article className="card flex flex-col group hover:border-brand-600/30 transition-all duration-300">
      ...
      {post.image_url ? (
        ...
        <div className="aspect-video rounded-xl mb-4 bg-gradient-to-br from-brand-900/40 to-brand-600/10 flex items-center justify-center">
          <svg
            className="w-10 h-10 text-brand-600/40"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
