...
export const metadata = {
  title: "Careers — Join CAXiE Technologies Ltd",
  description:
    "Explore open roles at CAXiE Technologies Ltd — a cybersecurity-first IT consultancy in Kano, Nigeria. We hire engineers, analysts, and strategists who want to build technology that matters.",
  openGraph: {
    title: "Careers at CAXiE Technologies Ltd",
    description:
      "Join the team behind cybersecurity, infrastructure, and digital transformation in Nigeria.",
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-gray-400 text-lg max-w-2xl leading-relaxed">
            At CAXiE, every person on the team works on real client problems
            with real consequences — not demos or internal tools. We operate
            lean, move with urgency, and hold each other to a high standard.
          </p>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          <span
                            className={`text-xs font-medium px-2.5 py-1 rounded-full border ${typeColors[job.type] || "bg-gray-800 text-gray-400 border-gray-700"}`}
                          >
                            {job.type}
                          </span>
                          <span className="text-xs text-gray-500 flex items-center gap-1">
                            ...
                            >
                              <path
                                ...
                                strokeWidth={2}
                                d="M17.657 16.657L13.414 12.414a2 2 0 00-2.828 0l-4.243 4.243A8 8 0 1112 20a7.963 7.963 0 01-4.243-1.243z"
                              />
                            </svg>
                            {job.location}
                          </span>
            ...
            <div className="mt-10 card border border-brand-600/20 bg-brand-600/5">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    We grow our team based on capability, not just open
                    headcount. If you&apos;re exceptional at cybersecurity,
                    software engineering, data science, or IT infrastructure —
                    introduce yourself. We review speculative applications
                    seriously.
                  </p>
                </div>
                <a
                  href="mailto:careers@caxietechnologies.com?subject=Speculative Application — CAXiE Technologies Ltd"
            ...
            {[
              {
                step: "01",
                title: "Application",
                desc: "Send your CV and a short note on what you can contribute. No cover letter templates — be specific.",
              },
              {
                step: "02",
                title: "Intro call",
                desc: "30-minute call with Xavier. We want to understand your experience and what motivates you.",
              },
              {
                step: "03",
                title: "Technical assessment",
                desc: "A focused, role-relevant task — usually 2–4 hours. We respect your time and always give feedback.",
              },
              {
                step: "04",
                title: "Offer",
                desc: "If it's a fit on both sides, we move to offer within 5 business days of your final assessment.",
              },
            ].map((s) => (
