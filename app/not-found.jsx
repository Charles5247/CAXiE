...
export const metadata = {
  title: 'Page Not Found — CAXiE Technologies',
};
    ...
    <div className="bg-[#0f0a1a] min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-400 mb-8">
          This page doesn&apos;t exist or may have moved. If you followed a link from the old Netlify site, please check the navigation above — all pages have been migrated to the new URL structure.
        </p>
