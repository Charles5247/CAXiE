...
import logoImage from "@/components/ui/caxie_tech_bw.png";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Link
            ...
            aria-label="CAXiE Technologies Ltd home"
          >
            <Image
              src={logoMark}
              alt="CAXiE logo"
      ...
      >
        ...
        {/* Navigation links */}
        <nav
          className={`flex-1 py-6 space-y-1 transition-all duration-250 ${collapsed ? "px-2" : "px-4"}`}
          aria-label="Main navigation"
        >
          {navLinks.map((link, idx) => {
            ...
            return (
              ...
              >
                {/* Icon (always shown) */}
                <span
                  className={`flex-shrink-0 ${active ? "text-brand-400" : "text-gray-400 group-hover:text-white"}`}
                >
                  {navIcons[idx]}
                </span>
