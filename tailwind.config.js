...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'hero-gradient': 'linear-gradient(135deg, #3b0764 0%, #581c87 30%, #1e1b4b 70%, #0f0a1a 100%)',
        'section-gradient': 'linear-gradient(180deg, #0f0a1a 0%, #1a0f2e 100%)',
        'card-gradient': 'linear-gradient(135deg, rgba(147, 51, 234, 0.1) 0%, rgba(109, 40, 217, 0.05) 100%)',
      },
      boxShadow: {
